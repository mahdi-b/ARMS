...
class Ungap_Program_Chewbacca(ChewbaccaProgram):
    ...
    def execute_program(self):
        args = self.args
        self.ungap_chewbacca(args.input_f, args.outdir, args.gapchars, args.fileext, args.threads)


    def ungap_chewbacca(self, input_f, outdir, gapchars, file_ext, threads):
