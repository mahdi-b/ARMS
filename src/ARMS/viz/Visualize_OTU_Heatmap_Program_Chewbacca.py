...
class Visualize_OTU_Heatmap_Program_Chewbacca(ChewbaccaProgram):
    ...
    def execute_program(self):
        args = self.args
        self.visualize_otu_heatmap(args.input_f, args.outdir, args.filetype, args.clip, args.processes)

    def visualize_otu_heatmap(self, input_f, outdir, filetype, clip, processes):
        ...
        data_frame.transpose().plot(kind='bar', stacked=True, ylim=(0, 1), figsize=(10 + ncols / .5,
                                                                                    7 + nrows / 10.0),
                                    colormap=plt.cm.hsv)
