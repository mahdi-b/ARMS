...
python chewbacca.py assemble -p pear -n test -f /home/greg/ARMS/testARMS/testData/20K_R1.fq  \
    -r /home/greg/ARMS/testARMS/testData/20K_R2.fq  -o 1_assembled -t 1 -m 550

# rename the sequence as 1, 2, 3 ... rather the long Illumina names
python ~~/ARMS/bin/rename_sequences.py BALI.assembled.fastq  BALI.assembled_renamed.fastq fastq
