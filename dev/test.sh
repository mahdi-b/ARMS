...
python ~/ARMS/src/ARMS/dev/alignReadsProt.py ~/ARMS/data/bold100k.fna bads.fasta bads_20.out  ~/ARMS/data/bold100k_name_pairs.txt ~/ARMS/data/bold100k.faa True > h_rslt.out
grep Error.*_i.* -B 2 h_rslt.out > h_errors.txt
python ~/ARMS/src/ARMS/dev/alignReadsProt.py ~/ARMS/data/bold100k.fna bads.fasta bads_20.out  ~/ARMS/data/bold100k_name_pairs.txt ~/ARMS/data/bold100k.faa False > dumb_rslt.out
